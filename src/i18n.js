  ...
  en: {
    ...
    layers: {
      ...
      'overlay-microparcels': { label: 'Micro-parcels (1000-unit master grid)',
        legend: '<div><b>Subdivision grid:</b> ~1000 parcel cells × ~70.5 m² covering <b>100% of the site</b> — every cell is a polygon clipped to the cadastral boundary, and adjacent cells combine into larger lots. Blue hotel, orange residences, pink VPP, gold equestrian, pale-green commons; dark cells = trail spine &amp; cross-paths. <b>Buildability score:</b> development cells rated 0–100 from slope (EU-DEM), trail access (&lt;300 m) and zone constraints — bright fill = optimal, dim = constrained. <b>Parking:</b> brown dashed 25-cell cluster (~1,762 m² subterranean garage) at the Z1 access junction. <b>Click any cell</b> for area, elevation, slope, access and score.</div>' },
  ...
  es: {
    ...
    layers: {
      ...
      'overlay-microparcels': { label: 'Micro-parcelas (cuadrícula maestra de 1000 unidades)',
        legend: '<div><b>Cuadrícula de subdivisión:</b> ~1000 celdas × ~70.5 m² que cubren el <b>100% de la finca</b> — cada celda es un polígono recortado al límite catastral, y las celdas contiguas se combinan en lotes mayores. Azul hotelero, naranja residencias, rosa VPP, dorado ecuestre, verde claro commons; celdas oscuras = espina de senderos y caminos transversales. <b>Edificabilidad:</b> celdas de desarrollo calificadas 0–100 según pendiente (EU-DEM), acceso a la espina (&lt;300 m) y restricciones de zona — relleno brillante = óptimo, atenuado = limitado. <b>Aparcamiento:</b> cluster marrón punteado de 25 celdas (~1,762 m² garaje subterráneo) junto al acceso Z1. <b>Haz clic en cualquier celda</b> para ver área, altitud, pendiente, acceso y puntuación.</div>' },
