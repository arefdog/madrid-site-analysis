  ...
  en: {
    ...
    layers: {
      ...
      'overlay-microparcels': { label: 'Micro-parcels (1000-unit master grid)',
        legend: '<div><b>Zone distribution:</b> 1000 parcels × 70.5 m² = 70,484 m². Blue hotel (198), orange residences (227), pink VPP (64), gold equestrian (85), green commons/roads (425). <b>Buildability score:</b> Each development parcel rated 0–100 based on slope, road access (<300m to spine), and zone constraints. Bright = optimal, dim = constrained. <b>Parking:</b> Brown dashed cluster near Z1 access (1,762 m² subterranean garage). <b>Click any parcel</b> for elevation, access distance, buildability status.</div>' },
  ...
  es: {
    ...
    layers: {
      ...
      'overlay-microparcels': { label: 'Micro-parcelas (cuadrícula maestra de 1000 unidades)',
        legend: '<div><b>Distribución de zonas:</b> 1000 parcelas × 70.5 m² = 70,484 m². Azul hotelero (198), naranja residencias (227), rosa VPP (64), dorado ecuestre (85), verde commons/caminos (425). <b>Puntuación de edificabilidad:</b> Cada parcela de desarrollo calificada 0–100 según pendiente, acceso a espina (<300m), y restricciones de zona. Brillante = óptimo, atenuado = limitado. <b>Aparcamiento:</b> Cluster marrón punteado cerca de acceso Z1 (1,762 m² garaje subterráneo). <b>Haz clic en cualquier parcela</b> para ver altitud, distancia de acceso, estado de edificabilidad.</div>' },
