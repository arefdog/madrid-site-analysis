  ...
  en: {
    ...
    layers: {
      ...
      'overlay-microparcels': { label: 'Micro-parcels (1000-unit master grid)',
        legend: '<div>Boalo master parcel grid: 1000 micro-parcels distributed by zone percentage, respecting topography and existing conditions. Blue = hotel core (198), orange = residences (227), pink = VPP (64), gold = equestrian (85), green = commons/roads/parking (425). Respects terrain slope and landcover.</div>' },
  ...
  es: {
    ...
    layers: {
      ...
      'overlay-microparcels': { label: 'Micro-parcelas (cuadrícula maestra de 1000 unidades)',
        legend: '<div>Cuadrícula de parcelas de Boalo: 1000 micro-parcelas distribuidas por porcentaje de zona, respetando topografía y condiciones existentes. Azul = núcleo hotelero (198), naranja = residencias (227), rosa = VPP (64), dorado = ecuestre (85), verde = commons/caminos/aparcamiento (425). Respeta pendientes y cobertura del terreno.</div>' },
