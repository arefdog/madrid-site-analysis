  ...
  en: {
    ...
    layers: {
      ...
      'overlay-masterplan': { label: 'Masterplan zones',
        legend: '<div>Zoning suggestions per BYLD: roads (gray), residential (orange), hotel/spa (blue), affordable housing (pink), green/dehesa (pale green). <b>Click a zone</b> for area, program, phasing gates, and CTE compliance codes. Colmenarejo: 4-villa cluster. Boalo: phased resort (Phase 1 residential, Phase 2 conditional hotel).</div>' },
  ...
  es: {
    ...
    layers: {
      ...
      'overlay-masterplan': { label: 'Zonas de Plan Maestro',
        legend: '<div>Propuesta de zonificación BYLD: viarios (gris), residencial (naranja), hotel/spa (azul), vivienda asequible (rosa), verde/dehesa (verde pálido). <b>Haz clic en una zona</b> para ver área, programa, fases y códigos CTE. Colmenarejo: cluster de 4 villas. Boalo: resort escalonado (Fase 1 residencial, Fase 2 hotel condicional).</div>' },
